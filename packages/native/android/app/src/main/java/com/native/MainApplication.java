...
import tech.bam.rnperformance.startuptrace.StartupTraceModule; // @firebase-perf
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.native.ReactNativeFlipper");
        aClass
